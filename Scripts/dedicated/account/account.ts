...
<div class="d-flex flex-column align-items-center w-lg-50 h-100 px-1 px-lg-1  bg-secondary">
    <div class="w-100 mt-auto fade-in" style="max-width: 526px;">
        ...
        <!-- Copyright-->
        <p class="w-100 fs-sm pt-5 mb-5" style="max-width: 526px;"><span class="text-muted">almondCove.in</span></p>
    ...
    <div class="w-100 mt-auto fade-in" style="max-width: 526px;">
        ...
        <form class="needs-validation" id="loginForm" novalidate>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between pb-4">
                ...
                </div><router-link class="fs-sm fw-semibold text-decoration-none my-1" to="/account/accountrecovery">Forgot password?</router-link>
            </div>
            <button 
                class="btn btn-lg btn-primary w-100 mb-4 fade-in-delay" 
                type="button" 
                v-on:click="submitLogin"
            ><span v-html="buttonText"></span></button>

        </form>
    </div>
    <!-- Copyright-->
    <p class="w-100 fs-sm pt-5 mt-auto mb-5" style="max-width: 526px;"><span class="text-muted">almondCove.in</span></p>
    ...
    <div class="w-100 mt-auto fade-in" style="max-width: 526px;">
        ...
        <form class="needs-validation" id="loginForm" novalidate>
            <div class="pb-3 mb-3">
                <div class="position-relative">
                    <i class="ai-mail fs-lg position-absolute top-50 start-0 translate-middle-y ms-3"></i>
                    <input class="form-control form-control-lg ps-5" v-model="OTP" v-on:keyup.enter="verifyAcc" type="text" placeholder="enter otp" value="" autocomplete="off" required>
                </div>
            </div>

            
            <button class="btn btn-lg btn-primary w-100 mb-4 fade-in-delay" type="button" v-on:click="verifyAcc"><span v-html="buttonText"></span></button>
